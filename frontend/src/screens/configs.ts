...
import { cur, locale, taxLabel } from "../lib/money"
...
export const companiesConfig: ScreenConfig = {
  ...
  form: [
    ...
    { field: "gstin", label: locale().tax_id_label, type: "data" },
    { field: "contact_name", label: "Contact name", type: "data" },
    { field: "contact_phone", label: "Contact phone", type: "data" },
    { field: "contact_email", label: "Contact email", type: "data" },
...
export const billingConfig: ScreenConfig = {
  ...
  title: "Billing",
  description:
    `Reservation totals. Folios, charge posting and ${taxLabel()} invoices arrive in the next milestone.`,
  propertyScoped: true,
  allowCreate: false,
  allowDelete: false,
